...
<head>
    ...
    <style>
        .image-container {
            background-image: url("../Static Assets/assets/images/modeMedium.jpg");
    ...
    <script>
        ...
        function resetGameAndSaveData() {
            // Make a POST request to save the game data to the database
        ...
        function displayStreakPopup() {
            ...
            Swal.fire({
                ...
                text: "You Got a Streak! Press the button to add 10 seconds to your timer.",
                icon: "success",
                ...
                if (result.isConfirmed) {
                    console.log("Adding 10 seconds to timer");
                    timeLeft += 10;
                    updateUI();
                }
                hideConfetti(); 
        ...
        <div class="container d-flex align-items-center justify-content-between mt-5">
            <div class="form-container mx-4 row">
                <div class="single-Data">
                    <span style="background-color: #F2D000;color: black;">Question <span id="question-number" class="fw-bold">1</span></span>
                    <span style="background-color: #F2D000;color: black;">Score <span id="score" class="fw-bold">0</span></span>
                    <span style="background-color: #F2D000;color: black;">Time <span id="timer" class="fw-bold">45</span></span>
                </div>
